...
(function () {
	...
	Window_MapInformation.prototype.drawInformation = function() {
		...
		//Original: var text = $gameSystem.informationWindowText(this._index);
		this.drawTextEx(text, 4, -10); // text, offset x, offset y
		//Original: this.drawTextEx(text, 8, 8); -Kendrian
	};
